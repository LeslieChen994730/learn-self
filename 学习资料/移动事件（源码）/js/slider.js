function Slider(el, options) {
  ...
  this.options.initIndex =
    typeof options.initIndex !== 'undefined'
      ...
      : defaults.initIndex;
  this.options.speed =
    typeof options.speed !== 'undefined' ? options.speed : defaults.speed;
  this.options.hasIndicator =
    typeof options.hasIndicator !== 'undefined'
      ? options.hasIndicator
      : defaults.hasIndicator;
...
Slider.prototype._setIndicatorActive = function(index) {
  this.indicators =
    this.indicators || this.el.querySelectorAll('.slider-indicator');
